//
//  AddMonthlyPlanViewController.m
//  Order
//
...
CGFloat const gestureMinimumTranslation_d = 5.0 ;
...
@interface AddMonthlyPlanViewController () <UITableViewDelegate, UITableViewDataSource, AddMonthlyPlanTableViewCellDelegate, ShoppingCartTableViewCellDelegate, SelectGoodsServiceDelegate, OrderConfirmServiceDelegate, LMBlurredViewDelegate> {
...
@implementation AddMonthlyPlanViewController

#define kCellHeight 69

#define kCellName @"AddMonthlyPlanTableViewCell"
...
- ( CameraMoveDirection )determineCameraDirectionIfNeeded:( CGPoint )translation {
    ...
    if (fabs(translation.x) > gestureMinimumTranslation_d) {
    ...
    else if (fabs(translation.y) > gestureMinimumTranslation_d) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(tableView.tag == 1001) {
        ...
        AddMonthlyPlanTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellId forIndexPath:indexPath];
        cell.delegate = self;
...
#pragma mark - AddMonthlyPlanTableViewCellDelegate
...
- (void)successOfOrderConfirm:(PromotionOrderModel *)promotionOrder {
    ...
    ConfirmMonthlyPlanViewController *vc = [[ConfirmMonthlyPlanViewController alloc] init];
